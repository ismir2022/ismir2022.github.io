  ...
  return (
    <div className="space-y-5">
      <div className="space-y-3">
        ...
        <p className="text-xl">
          ISMIR 2022 is committed to providing a harassment-free experience for
          everyone. All attendees, speakers, sponsors, and volunteers at our
          conference are required to agree with the following code of conduct.
          Organizers will enforce this code throughout the event. We expect
          cooperation from all participants to help ensure a safe environment
          for everybody.
        </p>
      </div>
      <div className="space-y-3">
        ...
        <p className="text-xl">
          ...
          or have any other concerns regarding conference conduct, you may
          report it through any the following channels:
        </p>
        ...
        <p className="text-2xl font-bold">The Quick Version</p>
        <p className="text-xl">
          ...
          choices. Participants are expected to engage in constructive,
          respectful, and inclusive conversations, and harassment of conference
          participants in any form will not be tolerated. Participants are
          expected to respect the privacy protocols of the conference. This Code
          of Conduct applies to all ISMIR 2022 activities including both
          physical and virtual events comprising talks, poster sessions,
          tutorials, workshops, social events, Twitter, and other online media.
        ...
        <p className="text-2xl font-bold">The Less Quick Version</p>
        <p className="text-xl font-bold">Harassment</p>
        <p className="text-xl">
          Harassment includes offensive verbal comments related to gender,
          gender identity and expression, age, sexual orientation, disability,
          physical appearance, body size, race, ethnicity, nationality,
          religion, technology choices, posting of inappropriate sexual images,
          deliberate intimidation, stalking, following, harassing photography or
          recording, sustained disruption of talks or other events,
          inappropriate physical contact and unwelcome sexual attention. Other
          forms of harassment for the virtual format of ISMIR 2022 include
          disrupting the virtual meeting (e.g., “zoom-bombing”), engaging in
          harm or threats of harm of any kind, and creating/contributing to a
          safety threat or unsafe or exclusionary situation.
        </p>
        <p className="text-xl">
          Sponsors are also subject to the anti-harassment policy. In
          particular, sponsors should not use sexualised images, activities, or
          other material. Sponsors should not use sexualised
        ...
        <p className="text-xl">
          We expect participants to follow these rules at ISMIR 2022 conference
        ...
        <p className="text-xl">
          ...
          unless explicit permission has been granted by all participants.
        </p>
        <p className="text-xl">
          Do not take or share screenshots of participants or presenters without
          explicit permission from everyone present or making sure that
          participants cannot be identified.
        </p>
        <p className="text-xl">
          Do not share audio or video recordings of ISMIR 2022 besides those
          released by the conference (via social media or any other means)
          unless these have been posted with permission by all participants.
        </p>
        <p className="text-xl">
          Do not take or distribute pictures of or copy research
        ...
        <p className="text-xl">Chat logs can be saved for personal use only.</p>
        <p className="text-xl font-bold">Consequences/Enforcement</p>
        <p className="text-xl">
        ...
        <p className="text-xl">
          This work, “ISMIR 2022 Code of Conduct”, is a derivative of{" "}
          <span className="text-[#d83616]">
