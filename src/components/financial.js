    ...
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        ...
        <ul className=" text-lg list-disc list-inside">
          ...
          <li>July 25, 2022: Application deadline for Author Grants</li>
          <li>
            August 3, 2022: Author Grant notifications (for applications
            submitted by July 25, 2022)
          </li>
          <li>
            August 12, 2022: Registration deadline for authors of accepted
            papers
          </li>
          <li>
            August 19, 2022: Application deadline for Music Author Grants and
            WiMIR Grants
          </li>
          <li>August 24, 2022: Grant notifications for Music Author Grants</li>
          <li>
            August 24, 2022: Grant notifications for WiMIR grants (for
            applications submitted by August 19, 2022)
          </li>
          <li>
        ...
        <p className="text-lg">
          ...
          Child care grants and local accommodation grants are under
        ...
        <p className="text-lg">
          ...
          awarded based on quality of the accepted submission, the degree of
        ...
        <p className="text-lg">
          ...
          available for both in-person and virtual participation in the
        ...
        <ul className="text-lg list-disc list-inside">
          ...
          <li>
            Minorities in MIR: Applicants identifying as Black, African,
            African-American or an ethnic/racial minority (of the applicant’s
            region)
          </li>
          <li>
          ...
          <li>
            Unaffiliated researcher: Applicants who currently have no
            professional affiliation that will cover the conference registration
            fee
          </li>
          <li>
            Women in MIR: Applicants identifying as a woman or other gender
            minority
          </li>
        </ul>
        ...
        <p className="text-lg">
          ...
          author applicants are sent out no later than August 3, 2022 (if
          applied by July 25, 2022). WiMIR Grant notifications for non-authors
        ...
        <p className="text-lg">
          ...
          information provided on the application shall only be used for
          assessment of grant eligibility and not for any other purpose. The
          information will not be shared beyond the members of the ISMIR 2022
          grants committee.
        </p>
