      ...
      <div className="space-y-3">
        ...
        <div className="flex md:flex-row flex-col gap-y-10 md:gap-y-0 gap-x-10">
          <div className="text-center">
            ...
            <div className="space-y-3 text-lg text-left">
              ...
              <p>
                Large sized logo displayed on the video broadcasts and (if
                applicable) conference platforms
              </p>
              <p>5 free registrations</p>
              <p>
                Sponsorship acknowledgment and announcements on social media
              </p>
              <p>Large “Virtual Booth” in the conference platform</p>
              <p>Dedicated “communication channel” during the conference</p>
              <p>
                Dedicated full session in the industry meetup in the conference
                program
              </p>
              <p>
                Post jobs and internships on the careers page of ISMIR 2022
                website
              </p>
              <p>2 promo items /social event prize</p>
              <p>Access to opt-in attendee “CV pool”</p>
              <p>Submit promoted posts to the “job board”</p>
              <p>Reserved seat in 2 industry events</p>
              <p>1 sponsored talk</p>
              <p>Sponsorship of awards</p>
              <p>Logo on conference bag </p>
              <p>Promotional video on screen at the banquet</p>
            </div>
          </div>
          <div className="text-center">
            ...
            <div className="space-y-3 text-lg text-left">
              ...
              <p>
                Medium sized logo displayed on the video broadcasts and (if
                applicable) conference platforms
              </p>
              <p>2 free registrations</p>
              <p>
                Sponsorship acknowledgment and announcements on social media
              </p>
              <p>Half page advertisement in conference booklet</p>
              <p>Medium “Virtual Booth” in the conference platform</p>
              <p>Dedicated “communication channel” during the conference</p>
              <p>
                Short session in the industry meetup in the conference program
              </p>
              <p>
                Post jobs and internships on the careers page of ISMIR 2022
                website
              </p>
              <p>1 promo item/social event prize</p>
              <p>Medium physical booth at the conference venue</p>
              <p>Access to opt-in attendee “CV pool”</p>
              <p>Submit posts to the “job board”</p>
              <p>Reserved seat in 1 industry event</p>
            </div>
          </div>
          <div className="text-center">
            ...
            <div className="space-y-3 text-lg text-left">
              ...
              <p>
                Small sized logo displayed on the video broadcasts and (if
                applicable) conference platforms
              </p>
              <p>1 free registration</p>
              <p>
                Sponsorship acknowledgment and partial announcement on social
                media
              </p>
              <p>Quarter page advertisement in conference booklet</p>
              <p className="text-blue-600">Select one of the benefits below:</p>
              <p className="text-blue-500">
                Small “Virtual Booth” in the conference platform.
              </p>
              <p className="text-blue-500">
        ...
        <div className="text-center gap-y-5 space-y-5 w-1/3">
          ...
          <div className="space-y-3 text-lg text-left">
            ...
            <p>
              Small logo displayed on the video broadcasts and (if applicable)
        ...
        <div className="flex md:flex-row flex-col gap-y-10 md:gap-y-0 gap-x-10">
          <div className="text-center">
            ...
            <div className="space-y-3 text-lg text-left">
              ...
              <p>Acknowledgement in talks dedicated to WiMIR/Women speakers</p>
            </div>
          </div>
          <div className="text-center">
            <div className="bg-gradient-to-r from-transparent via-amber-300 font-bold text-xl">
