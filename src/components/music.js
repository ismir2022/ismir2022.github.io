    ...
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        <p className="text-lg">
          ...
          composers, technologists, and performers for inclusion in the
          conference’s concert program. Submissions demonstrating applications
          of music information retrieval, computational musicology, human
          computer interaction, machine accompaniment, call-response, ethical
        ...
        <ul className="text-lg list-disc list-inside">
          ...
          <li>Music author grant application deadline: Aug 19, 2022</li>
        ...
        <p className="text-lg">
          ...
          the accepted music submission, the degree of financial need, the
        ...
        <ul className="text-lg list-disc list-inside">
          <li>
            ...
            offline — performers in different locations can pre-record each
            track and assemble it with others’ tracks by post editing, to
            perform as if the performances were played at the same time; (ii)
            Networked live — participants can also select to do a live
            performance using specialized audio streaming software (like
            Jacktrip, Soundjack) providing the audio to a multiple screen chat
            application like Zoom. The accepted submissions will be played back
            on-site as well as broadcast live.
          </li>
          <li>
            <span className="font-bold">Live Ensemble:</span> Participants form
            teams to compose ensemble performances that can be performed live. A
            recording of the edited ensemble has to be submitted for review,
            however, the accepted works will be performed live on-site and
            broadcast live.
          </li>
          <li>
            <span className="font-bold">Creative Visuals for Music:</span>{" "}
            Participants are encouraged to apply creative visual effects to
            accompany music. This includes but is not limited to AI-powered
            visual effects (e.g., facial distortion, video filtering) synced
            with music contents, animations or fictions, body performances,
            movements and gestures, etc.
          </li>
          <li>
            <span className="font-bold">Adaptations to Post-pandemic Era:</span>{" "}
            Participants are encouraged to create musical/sound art works that
            emphasizes the adaptations innovated during the mandated home studio
        ...
        <p className="text-lg">
          ...
          interactions. For broadcast of pre-recorded videos, performers are
        ...
        <ul className="text-lg list-disc list-inside">
          ...
          <li>
            Video/audio performance of the piece, as .mp4, .mov, .wav, .aif,
            .flac format with file size &lt; 100MB or an online link
            (preferably).
            <ul className="list-disc list-inside">
              <li>
                For non-live performance, the video file will be broadcast
                during the concert.
              </li>
              <li>
                For live performance, please also submit a video/audio of a
                previous performance along with descriptions of implementation
                details of the live streaming.
              </li>
            </ul>
          </li>
        </ul>
        <p className="text-lg">
          ...
          post-processed titles and subtitles, since there will be no commenter
        ...
        <p className="text-lg">
          ...
          system for a light review. There is no guarantee that all submissions
          will be accepted for the program. Please note the submission proposal
          is for informative purposes for the selection and will not be included
        ...
        <p className="text-lg">
          ...
          already ISMIR paper authors and have registered for the conference,
          their music submission can be covered with the same registration.
