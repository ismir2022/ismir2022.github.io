      ...
      <div className="bg-[#FCF0E1] px-5 w-fit h-[550px] overflow-y-scroll md:px10 py-5 space-y-5">
        <div className="space-y-3 place-content-evenly">
          ...
          <div className="flex flex-col space-y-5 md:text-lg">
            ...
            <div className="flex flex-row space-x-5">
              <p className="w-1/2 breakword">
                Registration deadline for virtual attendance
              </p>
              <p className="breakword">December 5, 2022</p>
            </div>
            <div className="flex flex-row space-x-5">
              <p className="w-1/2 breakword">
                Registration at the venue (for in-person attendance)
              </p>
        ...
        <div className="space-y-3 place-content-evenly">
          ...
          <div className="flex flex-col space-y-5 md:text-lg">
            ...
            <div className="flex flex-row space-x-5">
              <p className="w-1/2 breakword">
                Performance-ready submission deadline
              </p>
        ...
        <div className="space-y-3 place-content-evenly">
          ...
          <div className="flex flex-col space-y-5 md:text-lg">
            ...
            <div className="flex flex-row space-x-5">
              <p className="w-1/2 breakword line-through">
                Deadline for mentees for paper submission
              </p>
              <p className="breakword line-through">March 25, 2022</p>
            </div>
            <div className="flex flex-row space-x-5">
              <p className="w-1/2 breakword line-through">
                Notification for Mentor-Mentee match
              </p>
