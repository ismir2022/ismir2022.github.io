...
const Latebreaking = () => {
    return (
        ...
        <div className="space-y-3">
            <p className="text-lg">
                The Late-breaking/Demo (LBD) session is a forum for sharing prototype systems, initial concepts, and early
                results which may have not yet fully matured but are of interest to the Music-IR community.
                It is also a great entry point for people who are new to ISMIR to showcase their preliminary work and
                receive early feedback from fellow researchers.
                Attendees of the LBD can interact with demos or discuss their thoughts on the latest developments in the
                field.
            </p>
        </div>
        ...
        <ol>
            ...
            <li>Remote session: Dec 8, 2022 (Thu), 5.30 pm - 7.00 pm</li>
        </ol>
        </p>
    ...
    <p className="text-xl text-[#d83616] font-bold">Open Session</p>
        This year’s local LBD session is also an open session for students and independent researchers of the local
community.
        The session will enable participants to attend the late - breaking / demo session of the conference and interact with
        students, experts and senior members of the ISMIR research community.
        ...
        <dl>
            <div style={{paddingBottom:"10px"}}>
                <dt><strong>Hit Song Prediction For Indian Popular Music 2022 Lbd</strong></dt>
            ...
            <div style={{paddingBottom:"10px"}}>
                <dt><strong>EGFxSet: Electric Guitar Tones Processed Through Real Effects of Distortion, Modulation, Delay
                        and
                        Reverb</strong></dt>
            ...
            <div style={{paddingBottom:"10px"}}>
                <dt><strong>Ms21: A New Version Of Mixing Secrets Dataset For Music Source Separation</strong></dt>
                <dd>huicheng zhang</dd>
            </div>
            ...
            <div style={{paddingBottom:"10px"}}>
                <dt><strong>Differentiating The Pitch Bend Function Between The Sitar As A Real & Virtual
                        Instrument</strong>
                </dt>
            ...
            <div style={{paddingBottom:"10px"}}>
                <dt><strong>Improvisation in Tabla, the Hindustani classical percussion Instrument using Fibre made
                        Daya</strong></dt>
                <dd>Retnasree Iyer</dd>
            </div>

            <div style={{paddingBottom:"10px"}}>
                <dt><strong>On the Typicality of Musical Sequences</strong></dt>
            ...
            <div style={{paddingBottom:"10px"}}>
                <dt><strong>Rapidly Predicting Music Artistic Expression Preference From Heart Rate And Respiration Rate
                    </strong></dt>
            ...
            <div style={{paddingBottom:"10px"}}>
                <dt><strong>AI-driven, mobile-first web UI for controllable expressive piano performance
                        composition</strong>
                </dt>
            ...
            <div style={{paddingBottom:"10px"}}>
                <dt><strong>A Framework for Instrument Recognition Using Conditional Generative Adversarial
                        Networks</strong>
                </dt>
            ...
            <div style={{paddingBottom:"10px"}}>
                <dt><strong>MAP-Music2Vec: A Simple and Effective Baseline for Self-Supervised Music Audio Representation
                        Learning</strong></dt>
                <dd>Yizhi Li, Ruibin Yuan, Ge Zhang, Yinghao MA, Chenghua Lin, Xingran Chen, Anton Ragni, Hanzhi Yin, Zhijie
                    Hu,
