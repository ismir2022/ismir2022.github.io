  ...
  return (
    <div className="space-y-10">
      ...
      <dl>
        ...
        <div style={{paddingBottom:"10px"}}>
        <dt><strong>EGFxSet: ELECTRIC GUITAR TONES PROCESSED THROUGH REAL EFFECTS OF DISTORTION, MODULATION, DELAY AND REVERB</strong></dt>
        ...
        <div style={{paddingBottom:"10px"}}>
        <dt><strong>Ssm-Net: Feature Learning For Music Structure Analysis Using A Self-Similarity-Matrix Based Loss</strong></dt>
        <dd>Geoffroy Peeters, Florian Angulo</dd>
        </div>
        
        <div style={{paddingBottom:"10px"}}>
        <dt><strong>Differentiating The Pitch Bend Function Between The Sitar As A Real & Virtual Instrument</strong></dt>
        <dd>Suhit Chiruthapudi</dd>
        </div>
        
        <div style={{paddingBottom:"10px"}}>
        <dt><strong>ISMIR2022_LBD_Retnasree</strong></dt>
        ...
        <div style={{paddingBottom:"10px"}}>
        <dt><strong>Towards a machine-learning approach to analyse the emotional impact of source localization in music</strong></dt>
        <dd>Eleonora De Filippi, Timothy Schmele, ARIJIT  NANDI</dd>
        </div>
        
        <div style={{paddingBottom:"10px"}}>
        <dt><strong>Rapidly Predicting Music Artistic Expression Preference From Heart Rate And Respiration Rate </strong></dt>
        ...
        <div style={{paddingBottom:"10px"}}>
        <dt><strong>Differentiable WORLD Synthesizer-Based Neural Vocoder With Application To End-To-End Audio Style Transfer</strong></dt>
