    ...
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        ...
        <p className="text-lg"> Please note that an approval letter from Ministry of Home Affairs (MHA), 
          ...
          in which MHA approval is needed) along with your application (<span className="text-[#d83616] "> <a href= {mha_circular} target="_blank">
          Download MHA circular PDF</a></span>). 
        </p>
