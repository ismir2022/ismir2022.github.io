    ...
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        ...
        <ul className="text-xl list-disc list-inside">
          ...
          <li>
            Distance from NSSC (conference venue): 3.5 kilometres (10 mins
            drive)
          </li>
          <li>
            Location:{" "}
        ...
        <div>
          <p>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.103392665237!2d77.5407647!3d13.0290874!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae3d6b78323a6d%3A0x52c990fae2561020!2sTaj%20Yeshwantpur%2C%20Bengaluru!5e0!3m2!1sen!2ssg!4v1659061370529!5m2!1sen!2ssg"
              width="300vw"
              height="300vh"
              allowfullscreen=""
              loading="lazy"
        ...
        <div>
          <p>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.7995668596445!2d77.578344!3d12.9846679!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1778ed23d1f3%3A0xacab7252163d0c6c!2sVividus%20Hotels%20%2C%20Bangalore!5e0!3m2!1sen!2ssg!4v1659061210653!5m2!1sen!2ssg"
              width="300vw"
              height="300vh"
              allowfullscreen=""
              loading="lazy"
        ...
        <div>
          <p>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.170700726651!2d77.54785389999999!3d13.0247993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae3dba166ad3e3%3A0x23121b6d20aa130d!2sHoliday%20Inn%20Express%20Bengaluru%20Yeshwantpur%2C%20an%20IHG%20Hotel!5e0!3m2!1sen!2ssg!4v1659061075930!5m2!1sen!2ssg"
              width="300vw"
              height="300vh"
              allowfullscreen=""
              loading="lazy"
        ...
        <div>
          <p>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.76910887039!2d77.5747291!3d12.986614399999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae161798414663%3A0xd5d3e5a387c6bff!2sCitrine%20Hotel!5e0!3m2!1sen!2ssg!4v1659061515269!5m2!1sen!2ssg"
              width="300vw"
              height="300vh"
              allowfullscreen=""
              loading="lazy"
        ...
        <p className="text-xl font-bold">When to Apply</p>
        <p className="text-xl">
        ...
        <p className="text-xl font-bold">Share your Passport Details</p>
        <p className="text-xl">
        ...
        <p className="text-xl font-bold">Fill the Visa Application Form</p>
        <p className="text-xl">
        ...
        <p className="text-xl font-bold">Get your Supporting Documents</p>
        <p className="text-xl">
        ...
        <p className="text-xl font-bold">Photographs</p>
        <p className="text-xl">
        ...
        <p className="text-xl font-bold">Letter from your Institution</p>
        <p className="text-xl">
        ...
        <p className="text-xl font-bold">Accompanying Persons</p>
        <p className="text-xl">
        ...
        <p className="text-xl font-bold">Important Note</p>
        <p className="text-xl">
