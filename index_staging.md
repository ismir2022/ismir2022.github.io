...
<div style="background-color: rgb(255, 255, 255); height:25vh;float:right; width:63%; padding-left: 2vw; padding-right: 2vw; padding-top: 1vh; display:block;">
...
### Important Dates (AoE)
<table style="width:26vw; height:80vh; display: block; overflow-y:auto; overflow-x:hidden; background-color:rgb(255, 255, 255); padding-left: 2vw; padding-right: 2vw; padding-bottom: 1vh;">
        <tr>
...
<div style="float:left;"><a class="twitter-timeline" data-width="26vw" data-height="height:60vh;" href="https://twitter.com/ISMIRConf?ref_src=twsrc%5Etfw">Tweets by ISMIRConf</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script></div>
